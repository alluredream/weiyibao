...
public class SearchDaidingActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_daiding);
        //隐藏标题栏
        ...
        //http://221.193.236.253:8888/岗位/自动化部/关键联锁点/关键联锁点一览表.html
        String deptName = MainApplication.getInstance().stringHashMap.get("gangweiname");
        String url ="http://221.193.236.253:8888/岗位";
        String html = "关键联锁点.html";
        String address = url+"/"+deptName.replaceAll("#","%23")+"/"+"关键联锁点"+"/"+html;
        // webView.loadUrl("http://221.193.236.248:8081/pdf/7700风机关键联锁点一览表.html");
