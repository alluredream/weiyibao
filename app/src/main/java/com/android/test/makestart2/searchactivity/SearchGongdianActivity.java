...
public class SearchGongdianActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_gongdian);
        //隐藏标题栏
    ...
    public void openpage(){
        ...
        String html = "供电图.html";
        String address = url+"/"+deptName.replaceAll("#","%23")+"/"+"供电图"+"/"+html;
