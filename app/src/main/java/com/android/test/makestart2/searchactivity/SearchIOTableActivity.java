...
public class SearchIOTableActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_iotable);
        //强制横屏
...
// http://221.193.236.253:8888/岗位/1号2号7700风机/IO表/IO表.html
         String url ="http://221.193.236.253:8888/岗位";
        String html = "IO表.html";
        String address = url+"/"+deptName.replaceAll("#","%23")+"/"+"IO表"+"/"+html;
