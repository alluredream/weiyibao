...
public class SearchwangluoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_wangluo);
        //强制横屏
    ...
    public void openpage(){
        ...
        String html = "网络拓扑图.html";
        String address = url+"/"+deptName.replaceAll("#","%23")+"/"+"网络拓扑图"+"/"+html;
